...
Dieses Kapitel identifiziert die relevanten Stakeholder der BlitzerApp, beschreibt ihre Bedürfnisse und Erwartungen und definiert einen praxistauglichen Kommunikationsplan.

## 4.1 Identifikation der Stakeholder
- Endnutzerinnen und Endnutzer (Fahrerinnen/Fahrer)
  - Nutzen die App zur frühzeitigen Warnung vor stationären Blitzern; hohe Sensibilität für Datenschutz, Genauigkeit und Energieverbrauch.
...
- App-Store-Betreiber (Apple, Google)
  - Prüfen die App auf Richtlinienkonformität (Hintergrundortung, Datenschutz, lokale Rechtslage bei Blitzerwarnungen).
...
Ziele: Transparenz, Policy-Konformität, frühes Feedback und kontinuierliche Qualitätsverbesserung – bei minimaler externer Datenübertragung.
...
- Richtung OSM-Community
  - Kanäle: In-App-Hinweise zur Note-Qualität; Projektseite (z. B. GitHub/Docs) mit „Responsible Notes Guidelines“; ggf. OSM-Forum/Diary für Vorstellung.
